...
* [워크샵 소개](README.md)
* [사전 준비사항](prerequisites/README.md)

## Chapter 1: 프로젝트 설정 & Claude Code 소개

* [챕터 개요](chapter-01/README.md)
* [1.1 AWS 환경 설정](chapter-01/01-environment-setup.md)
...
* [챕터 개요](chapter-02/README.md)
* [2.1 대시보드 첫 시도](chapter-02/01-dashboard-first-attempt.md)
* [2.2 문서 기반 코드 생성](chapter-02/02-documentation-driven.md)
* [2.3 서버 컴포넌트 데이터 패칭](chapter-02/03-data-fetching.md)
* [2.4 Thinking 모드 & URL SearchParams](chapter-02/04-thinking-mode.md)
* [2.5 서버 액션 & 데이터 변이](chapter-02/05-data-mutations.md)
* [2.6 브랜치 관리 & Custom Slash Commands](chapter-02/06-branch-management.md)
* [2.7 편집 페이지 & 서브에이전트](chapter-02/07-edit-page-subagent.md)
